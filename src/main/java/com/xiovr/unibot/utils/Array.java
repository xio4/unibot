...
import com.xiovr.unibot.utils.ArrayReflection;
...
public class Array<T> implements Iterable<T> {
	...
	public Array (Array<? extends T> array) {
		...
		items = (T[])ArrayReflection.newInstance(array.items.getClass().getComponentType(), array.size);
		size = array.size;
	...
	public Array (boolean ordered, T[] array, int start, int count) {
		this(ordered, count, (Class<T>)array.getClass().getComponentType());
		size = count;
